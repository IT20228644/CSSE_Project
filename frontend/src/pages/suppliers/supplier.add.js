...
function Supplier() {
     ...
     const [suppliers,setSuppliers] = useState([])
      ...
      function Save(e){
            ...
            const addDoctor ={ name , email , telephone1 , address }

            axios.post("http://localhost:5000/supplier/addNewSupplier",addDoctor).then(() =>{
    ...
    function remove(id)
    { 
        axios.delete("http://localhost:5000/supplier/deleteSupplier/"+id).then(() =>{
            Swal.fire({  
                title: "Success!",
                ...
                <hr/>
                 <div className="container-fluid bg-white" style={{paddingLeft:'5%', paddingTop:'2%' ,paddingBottom:'2%', paddingRight:'5%'}} >
                     ...
                     <div class="alert alert-dark mt-3 mb-3 text-left" role="alert">
                            <h5 className="text-uppercase" style={{letterSpacing:'2px',textAlign: "left"}}>ALL Registerd Suppliers: {suppliers.length}</h5>
                        </div>
