...
function ItemAdd() {
    ...
    const [items,setItems] = useState([]);
          ...
          useEffect(() => {
              axios.get("http://localhost:5000/itemadd/allItems")
    ...
    function Save(e){
          ...
          axios.post("http://localhost:5000/itemadd/addItem",addItem).then(() =>{
  ...
  function remove(id)
  { 
      axios.delete("http://localhost:5000/itemadd/deleteItem/"+id).then(() =>{
          Swal.fire({  
              title: "Success!",
              text: "Item Deleted",
              icon: 'success',
                    ...
                    <MDBRow className='mt-3'>
                             ...
                             <MDBTable borderless className='mt-3' >
                              <MDBTableHead>
                                  <tr className="bg-dark">
                                       <th scope='col' className="text-white d-letter-spacing h6">Item Name</th>
                                     ...
                                     {items.map((item,key) => (
                                          <tr className="bg-light">
                                              ...
                                              <td className="text-center">
                                                  <MDBBtn size='sm' className="shadow-0" color='danger' onClick={() => remove(item._id)}><MDBIcon fas icon="trash-alt" /></MDBBtn>{''}&nbsp;&nbsp;
                                                  <MDBBtn size='sm' className="shadow-0" color='success' onClick={() => edit( item._id, item.name , item.price ,item.brand,item.quantity, item.image)}><MDBIcon fas icon="edit" /></MDBBtn>{''}&nbsp;&nbsp;
                                              </td>
                                          </tr>
                                     ))}
                              </MDBTableBody>
                      ...
                      <MDBCol sm='6'>
                          ...
                          <MDBCardBody  className="bg-light">
                              ...
                              <div class="mb-3">
                                  <label for="exampleFormControlInput1" class="form-label h6">Item Name</label>
                              ...
                              <div className="mb-3">
                                   <label for="exampleFormControlInput1" class="form-label h6">Item Image</label>
