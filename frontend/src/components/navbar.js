           ...
           <MDBNavbar expand='lg' className="sticky-top" light bgColor='dark'>
            <MDBContainer fluid>
                <MDBNavbarBrand href='/' style={{fontSize:'25px'}} className="pt-2 navbar-brand h1 fw-bold">
                    <MDBIcon fas icon="hard-hat" className="text-danger" size='2x' /> <span className="text-warning">&nbsp;Builder</span><span className="text-white">-Helper</span>
                </MDBNavbarBrand>
               ...
               <MDBCollapse navbar show={showNavRight}>
                ...
                <MDBNavbarNav right fullWidth={false} className='mb-2 mb-lg-0'>
                    ...
                    <MDBNavbarItem>
                    <MDBNavbarLink tabIndex={-1} aria-disabled='true' style={{color: 'white', cursor: 'pointer',margin:20}}>
